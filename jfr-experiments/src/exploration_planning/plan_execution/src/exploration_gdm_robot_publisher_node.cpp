...
int main( int argc, char** argv ){
        ...
        printf("\n=================================================================");
	    printf("\n=	        (ROBOT) Exploration GDM Publisher Node                 ");
	    printf("\n=================================================================\n");        
        
        ros::init(argc, argv, "exploration_gdm_robot_publisher_node");
	    ...
	    map_msg.text.clear();
	    map_msg.text = "The reconstruction is updated...";
	    ...
	    while (ros::ok()){
            ...
            if (accesstime_diff!=0){
                ...
                ROS_INFO("The reconstruction is updated...");
