...
void	performGasScan( ros::Publisher state_pub, \
                        double min_tilt_deg, \
                        double max_tilt_deg, \
                        double min_pan_deg, \
                        double max_pan_deg, \
